...
decoration = [
    "The decoration is ornate",
    "The decoration is plain",
    "The decoration is minimalistic",
    "The decoration is cluttered",
    "The decoration is tasteful",
    "The decoration is gaudy",
    "The decoration is elegant",
    "The decoration is rustic",
    "The decoration is classic",
    "The decoration is gothic",
]
...
torch_number = [
    " and a single lamp glows dimly.",
    " and a single candle flickers dimly.",
    " and a single torch dimly illuminates the room.",
    " and a strange orb glows in the distance.",
    " and a few lamps illuminate the room.",
    " and a few candles dimly illuminate the room.",
    " and a few torches illuminate the room.",
    " and a some strange orbs glow eerily.",
    " you see no light sources.",
]
...
occupancy = [
    "You feel a presence nearby, like you're not alone. You look around carefully. ",
    "It feels like something is watching you. ",
    "You take a few steps but can't shake the feeling that you're not alone, you turn around. ",
    "You feel like you're being hunted. ",
    "You hear a weird noise, you're starting to get nervous. ",
    "It feels like the room is closing in on you. ",
    "You feel there's no escape. ",
    "A shiver runs down your spine, something is creeping up on you, you quickly turn around. ",
    "The room feels like it's holding its breath, waiting for something to happen. ",
    "The hairs on the back of your neck stand up, and you know you're not alone. ",
    "You can sense a malevolent presence in the room, and it's making you uneasy. ",
    "You have an unsettling feeling that you're not welcome here. ",
    "The room feels heavy, and you can't shake the feeling that something bad is about to happen. ",
    "You feel like you're being suffocated, like the air is getting thinner and thinner. ",
]
...
occupancy_no_spawn = [
    ...
    "The room feels abandoned and neglected.",
    "The room feels hollow and lifeless.",
    "The room feels lonely and forgotten.",
    "The room is desolate, with no sign of life.",
    "The room is unwelcoming like a prison cell.",
    "The room is dusty and unkempt, as if no one has been there for years.",
    "The room is filled with a sense of foreboding.",
    "The room feels like it's from a parallel universe, and things are just a little bit off..",
    "The room is disorienting.",
    "The room is unsettling like a bad dream.",
    "The room is foreboding, with a sense of impending doom.",
    "The room feels oppressive, with a weight that bearas down on you.",
    "The room is filled with  mystery and intrigue.",
    "The room feels like a sanctuary, a safe haven from the world outside.",
    "The room is welcoming and warm, like an old friend.",
    "The room feels like a cocoon, a place to hide away from the world.",
    "The room is peaceful and serene, like a Zen garden.",
    "The room feels like a place of healing, where all worries are left behind.",
...
exits = [
    ...
    "a wooden staircase",
    "a spiral staircase",
    "a weathered staircase",
    "a rope ladder",
    "a vine ladder",
    "a magic steps floating",
]
...
what_in_front = [
    ...
    "You glimpse a ",
    "To the left there seems to be a ",
    "To the right there seems to be a ",
    "Up ahead there seems to be a ",
    "Far off there seems to be a ",
    "In the distance there seems to be a ",
    "Over there seems to be a ",
    "Pretty near there seems to be a ",
    "A short distance away there seems to be a ",
    "Not to far away there seems to be a ",
    "Within sight there lies a ",
    "A few steps away there seems to be a ",
    "Just up ahead there seems to be a ",
    "Behind a pile of garbage appears a ",
    "Behind a pile of bones appears a ",
    "Near a pile of garbage lies a ",
    "Near a pile of bones there is a ",
    "Near the rests of a campfire there seems to be a ",
    "Near the fireplace there is a ",
    "Near a bookshelf there is a ",
...
enemies = {
    "DRAGON": {
        "likelihood": 9,
        "attacks": "The dragon breathes a blast of fire at you, scorching the ground beneath your feet!",
        "hp": 200,
        "defeat": "The dragon lets out a deafening roar before falling to the ground.",
        "after": " The carcass of a dragon lies at your feet.",
        "no_attack": "The dragon sneezes, sending you flying backwards with the force of the blast! It seems uninterested in you.",
    },
    "cat on a shelf near a glass of water": {
        ...
        "no_attack": "The cat meows plaintively and stares at a loose thread on your clothing.",
    },
    "zombie": {
        "likelihood": 7,
        "attacks": "The zombie moves towards you, arms outstretched and moaning!",
        "hp": 60,
        "defeat": "The zombie groans and collapses into a pile of putrid meat.",
        "after": " A pile of guts and putrid zombie parts are part of the scene now.",
        "no_attack": "The zombie takes one look at you and decides you're not worth its time, shuffling off to do something more interesting.",
    },
    "crying ghost": {
        "likelihood": 5,
        "attacks": "The ghost wails angrily and flies towards you, phasing through walls and obstacles! It attacks!",
        "hp": 80,
        "defeat": "The crying ghost lets out a last wail before disappearing into the ether.",
        "after": " The ghost is gone, but you still feel uneasy.",
        "no_attack": "The ghost wails and sobs, bemoaning its own fate and leaving you to your own devices.",
    },
    "sitting gargoyle": {
        "likelihood": 4,
    ...
    "pack of rats": {
        ...
        "no_attack": "The rats skitter away at the sound of your approach, leaving behind a pile of stale bread crumbs.",
    },
    "giant spider": {
        "likelihood": 7,
        ...
        "after": " A big spider lies in front with its legs curled up and green goo keeps pouring from it.",
        "no_attack": "The spider recoils at the sight of you, looking like it has seen a ghost. It promptly turns and runs away as fast as its eight spindly legs can carry it, its dignity thoroughly shattered.",
    },
    "pig": {
        "likelihood": 2,
    ...
    "coffer with eyes?": {
        ...
        "hp": 80,
        "defeat": "The mimic makes a sophisticated and theatrical scream before revealing all its contents",
        "after": " The lifeless mimic lies before you. It had no treasure.",
        "no_attack": "The coffer blinks and blinks again, revealing itself to be a sentient mimic that is happy to chat.",
    },
    "rabbit with blood dripping from its mouth": {
        "likelihood": 8,
        "attacks": "The rabbit suddenly leaps at you, its teeth bared and its eyes wild with hunger!",
        "hp": 40,
        "defeat": "The rabbit jumps away to safety.",
        "after": " The rabbit looks at you at a distance.",
        "no_attack": "The rabbit hops over to you, looking cute and innocent, you are safe... for now...",
    },
    "mischievous imp": {
        "likelihood": 10,
        "attacks": "The imp cackles with glee and pelts you with small stones and bits of garbage!",
        "hp": 70,
        "defeat": "The imp cackles maniacally as it fades away.",
        "after": " The imp and its piercing, screeching laughs are gone.",
        "no_attack": "The imp cackles and performs a small dance for your amusement, then disappears in a puff of smoke.",
    },
    "swarm of bees": {
        "likelihood": 2,
        "attacks": "The bees swarm around you, stinging you repeatedly!",
        "hp": 60,
        "defeat": "The swarm of bees buzzes angrily before flying off, you swear one of them gave you the bird.",
        "after": " You search for the beehive, but find nothing.",
        "no_attack": "The bees buzz around you for a moment, then realize that you're not a flower and fly away.",
    },
    "wandering ghost with no memory": {
        "likelihood": 7,
        "attacks": "The ghost floats towards you, its eyes clouded and unseeing, but its ethereal remarks torment your soul!",
        "hp": 60,
        "defeat": "The wandering ghost hurts you one more time and fades away into the mist without looking back.",
        "after": " The wandering ghost is just but a memory now.",
        "no_attack": "The ghost floats past you without noticing you, lost in its own thoughts.",
    },
    "suit of armor": {
        "likelihood": 3,
        ...
        "no_attack": "The armor simply stands there, silent and inert, like an empty suit of armor.",
    },
    "group of animated garden gnomes": {
        "likelihood": 6,
        "attacks": "The gnomes swarm towards you, attacking you with their shovels, watering cans, lamps and pitchforks!",
        "hp": 60,
        "defeat": "The gnomes grunt and groan as they become inanimate once again.",
        "after": " You know you've always hated these things.",
        "no_attack": "The gnomes stare at you curiously, then go back to their gardening tasks.",
    },
    "shapeshifting slime creature": {
        "likelihood": 4,
        "attacks": "The slime oozes towards you and lashes out with pseudopods, attempting to engulf you and absorb you into its body!",
        "hp": 70,
        "defeat": "The shapeshifting slime lets out a wet gurgle before dissolving into a puddle.",
        "after": " You try not to step into the puddle...",
        "no_attack": "The slime creature transforms into a friendly puppy, wagging its tail and licking your hand.",
    },
    "tree": {
        "likelihood": 0,
        ...
        "after": " The tree stands lifeless, you feel guilty.",
        "no_attack": "You approach the massive tree. 'Greetings, traveler' a deep, rumbling voice echoes through your mind. 'Would you care for a refreshing drink and a tale or two?' The tree offers you a cup of cool, clear water and settles in to listen to your story.",
    },
    "grumpy old troll": {
        "likelihood": 8,
        "attacks": "The troll swings its club at you, attempting to knock you off and get your boy's soul!",
        "hp": 60,
        "defeat": "The grumpy old troll cries as the Dayman comes and takes it away",
        "after": " You can't stop thinking about that toll troll.",
        "no_attack": "The troll is too busy playing night crawlers to notice you.",
    },
    "scarecrow": {
        "likelihood": 3,
        "attacks": "The scarecrow suddenly springs to life, wielding a pitchfork and murderous eyes!",
        "hp": 40,
        "defeat": "The scarecrow makes a rustling sound before going limp.",
        "after": " A crow now rests on top of it, you have no idea where it came from",
        "no_attack": "The scarecrow comes to life, waving a friendly greeting as you approach. 'Hello there!' it chirps. 'Is there anything I can do to help you?' It then settles back into its post and doesn't move again.",
    },
    "flock of magical fire-breathing chickens": {
        "likelihood": 9,
        "attacks": "The chickens flutter towards you, belching flames and scorching the ground!",
        "hp": 60,
        "defeat": "The fire-breathing chickens let out a cacophony of clucks and squawks as they run away bursting into flames.",
        "after": " The chickens are now scattered piles of ash.",
        "no_attack": "The chickens cluck and peck at the ground, one of them roasts an unlucky worm",
    },
    "floating sword": {
        "likelihood": 5,
        ...
        "after": " After a couple seconds the sword disappeared, there's nothing there now.",
